...
// Fetch audit log records for display.
$result = $conn->query("SELECT * FROM audit_logs ORDER BY log_id DESC");
if ($result === false) {
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="d-flex justify-content-between align-items-center mb-4">
						<h3 class="mb-0">Audit Log List</h3>
						<a href="<?php echo BASE_URL; ?>crud_files/add_audit_log.php" class="btn btn-primary btn-sm">Add Audit Log</a>
					</div>
					<!-- Results table card. -->
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												<a href="<?php echo BASE_URL; ?>crud_files/edit_audit_log.php?id=<?= $row['log_id'] ?>" class="text-primary me-2" title="Edit">
													<i class="bi bi-pencil-square fs-5"></i>
												</a>
												<a href="<?php echo BASE_URL; ?>crud_files/delete_audit_log.php?id=<?= $row['log_id'] ?>" class="text-danger" title="Delete"
