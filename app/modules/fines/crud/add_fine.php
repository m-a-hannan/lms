...
// Handle form submission for creating a fine.
if (isset($_POST['save'])) {
    // Read and sanitize incoming form values.
    $loan_id = (int) $_POST['loan_id'];
    $amount = (float) $_POST['amount'];
    $fine_date = $conn->real_escape_string(trim($_POST['fine_date']));
    ...
    // Insert the fine record into the database.
    $sql = "INSERT INTO fines (loan_id, amount, fine_date, created_by, created_date, modified_by, modified_date, deleted_by, deleted_date) VALUES ($loan_id, $amount, '$fine_date', $created_by, '$created_date', $modified_by, '$modified_date', $deleted_by, '$deleted_date')";
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="mb-4 d-flex justify-content-between">
						<h3>Add Fine</h3>
						<a href="<?php echo BASE_URL; ?>fine_list.php" class="btn btn-secondary btn-sm">Back</a>
					</div>
					<div class="row mt">
						<div class="col-md-6">
							<!-- Fine creation form card. -->
							<div class="card card-primary card-outline mb-4">
								<!-- Submission form for a new fine. -->
								<form action="<?php echo BASE_URL; ?>crud_files/add_fine.php" method="post">
									<div class="card-body">
										...
										<div class="mb-3">
											...
											<input type="date" class="form-control" name="fine_date" />
										</div>
										<!-- Created by input. -->
										<div class="mb-3">
