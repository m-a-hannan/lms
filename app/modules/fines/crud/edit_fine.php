...
// Fetch the current fine record for editing.
$fine_id = (int) $_GET['id'];
...
if (isset($_POST['save'])) {
    ...
    // Update the fine record with the submitted values.
    $sql = "UPDATE fines SET loan_id = $loan_id, amount = $amount, fine_date = '$fine_date', created_by = $created_by, created_date = '$created_date', modified_by = $modified_by, modified_date = '$modified_date', deleted_by = $deleted_by, deleted_date = '$deleted_date' WHERE fine_id = $fine_id";
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="card shadow-sm">
						<div class="card-body">
							<!-- Submission form for updating the fine. -->
							<form method="post">
								<div class="row g-4">
									<div class="col-md-6">
										...
										<div class="mb-3">
											...
											<input type="date" class="form-control" name="fine_date" value="<?= htmlspecialchars($row['fine_date']) ?>" />
										</div>
										<!-- Created by input. -->
										<div class="mb-3">
