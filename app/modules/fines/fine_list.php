...
// Fetch fine records for display.
$result = $conn->query("SELECT * FROM fines ORDER BY fine_id DESC");
if ($result === false) {
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="d-flex justify-content-between align-items-center mb-4">
						<h3 class="mb-0">Fine List</h3>
						<a href="<?php echo BASE_URL; ?>crud_files/add_fine.php" class="btn btn-primary btn-sm">Add Fine</a>
					</div>
					<!-- Results table card. -->
								...
								<table class="table table-bordered table-hover align-middle">
									...
									<tbody>
										...
										<tr>
											...
											<?php // Render audit values when enabled. ?>
											<?php if ($showAuditColumns): ?>
											...
											<td class="text-center">
												...
												<a href="<?php echo BASE_URL; ?>crud_files/edit_fine.php?id=<?= $row['fine_id'] ?>" class="text-primary me-2" title="Edit">
													<i class="bi bi-pencil-square fs-5"></i>
												</a>
												<a href="<?php echo BASE_URL; ?>crud_files/delete_fine.php?id=<?= $row['fine_id'] ?>" class="text-danger" title="Delete"
