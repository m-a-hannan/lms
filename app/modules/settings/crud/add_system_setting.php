...
// Handle form submission for creating a system setting.
if (isset($_POST['save'])) {
    ...
    // Insert the system setting record into the database.
		...
		<div class="container-fluid">
			<div class="row">
				<div class="container py-5">
					...
					<div class="row mt">
						<div class="col-md-6">
							<!-- System setting creation form card. -->
							<div class="card card-primary card-outline mb-4">
								<!-- Submission form for a new system setting. -->
