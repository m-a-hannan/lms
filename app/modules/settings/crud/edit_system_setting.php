...
// Fetch the current setting record for editing.
$setting_id = (int) $_GET['id'];
$result = $conn->query("SELECT * FROM system_settings WHERE setting_id = $setting_id");
...
if (isset($_POST['save'])) {
    ...
    // Update the system setting record with the submitted values.
    $sql = "UPDATE system_settings SET created_by = $created_by, created_date = '$created_date', modified_by = $modified_by, modified_date = '$modified_date', deleted_by = $deleted_by, deleted_date = '$deleted_date' WHERE setting_id = $setting_id";
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="card shadow-sm">
						<div class="card-body">
							<!-- Submission form for updating the setting. -->
							<form method="post">
								<div class="row g-4">
									<div class="col-md-6">
										<!-- Created by input. -->
