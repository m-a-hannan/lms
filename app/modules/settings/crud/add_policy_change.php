...
// Handle form submission for creating a policy change.
if (isset($_POST['save'])) {
    ...
    // Insert the policy change record into the database.
		...
		<div class="container-fluid">
			<div class="row">
				<div class="container py-5">
					...
					<div class="row mt">
						<div class="col-md-6">
							<!-- Policy change creation form card. -->
							<div class="card card-primary card-outline mb-4">
								<!-- Submission form for a new policy change. -->
