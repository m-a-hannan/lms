...
// Fetch system setting records for display.
			...
			<div class="row">
				<div class="container py-5">
					...
					<div class="d-flex justify-content-between align-items-center mb-4">
						<h3 class="mb-0">System Setting List</h3>
						<a href="<?php echo BASE_URL; ?>crud_files/add_system_setting.php" class="btn btn-primary btn-sm">Add System Setting</a>
					</div>
					<!-- Results table card. -->
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												<a href="<?php echo BASE_URL; ?>crud_files/edit_system_setting.php?id=<?= $row['setting_id'] ?>" class="text-primary me-2" title="Edit">
										...
										<!-- Empty state message. -->
										<tr>
											<td colspan="<?php echo $showAuditColumns ? 8 : 2; ?>" class="text-center text-muted">No records found.</td>
										</tr>
										<?php endif; ?>
									</tbody>
								</table>
