...
$result = $conn->query("SELECT * FROM announcements WHERE announcement_id = $announcement_id");
...
if (isset($_POST['save'])) {
    ...
    $created_at = $conn->real_escape_string(trim($_POST['created_at']));
    ...
    $sql = "UPDATE announcements SET title = '$title', message = '$message', created_at = '$created_at', created_by = $created_by, created_date = '$created_date', modified_by = $modified_by, modified_date = '$modified_date', deleted_by = $deleted_by, deleted_date = '$deleted_date' WHERE announcement_id = $announcement_id";
					...
					<div class="card shadow-sm">
						<div class="card-body">
							...
							<div class="mb-3">
								...
								<input type="date" class="form-control" name="created_at" value="<?= htmlspecialchars($row['created_at']) ?>" />
							</div>
							<div class="mb-3">
